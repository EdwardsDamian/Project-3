...
Scrub.deleteMany().then(() => {
    ...
    const blueV = new Scrub({name: 'Blue Vanila', description: 'Contains sugar, food coloring and other natural ingredient', image: 'https://i.imgur.com/SMCiqph.jpg', size: '8 0z.', price: 8.00})
    return blueV.save();
}).then(() => {
